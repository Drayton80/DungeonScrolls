...
import door.opposite.grupo2.dungeonscrolls.databinding.ActivitySheetFeatsSkillsDfBinding;
...
public class SheetFeatsSkillsActivityDF extends AppCompatActivity implements  NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_sheet_feats_skills_df);
        sqLite = new SQLite(this);
        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        setSupportActionBar(toolbar);
        drawerLayout = (DrawerLayout)findViewById(R.id.sheetFS_drawer_menu);
        ...
        NavigationView mNavigationView = (NavigationView) findViewById(R.id.design_navigation_view_7);
        ...
        binding.setSalvarFicha(new EventoSalvar() {
            ...
            public void onClickSalvar() {
                fichaUsada.setTalentos(binding.getFichaElementos().talentos);
                fichaUsada.setPericias(binding.getFichaElementos().pericias);
